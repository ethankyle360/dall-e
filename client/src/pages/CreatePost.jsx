...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    if(form.prompt) {
      try {
        ...
        const response = await fetch('https://dall-e-32x7.onrender.com/api/v1/dalle', {
          method: 'POST',
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if(form.prompt && form.photo) {
      ...
      try {
        const response = await fetch('https://dall-e-32x7.onrender.com/api/v1/post', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        max-w[500px]">Create imaginative and
        visually stunning images through DALL-E AI
